...
public class SettingsActivity extends PreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(ResortManagerApp.sPrefOrganizationName));
            bindPreferenceSummaryToValue(findPreference(ResortManagerApp.sPrefTaskRefreshTime));
    ...
    public static class DatabasePreferenceFragment extends PreferenceFragment {
        private static String sPrefDatabaseType = "databaseType";
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(sPrefDatabaseType));
        }
